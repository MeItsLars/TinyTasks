...
public class ActivityManager {
    ...
    public static void startNewActivity(AppCompatActivity activity, Class newClass, Map<String, String> data) {
        Intent intent = new Intent(activity, newClass);
    ...
    public static void backToHomeActivity(AppCompatActivity activity, String fragment) {
    ...
    public static void startNewActivityTask(AppCompatActivity activity, Class newClass, boolean finishCurrent, int flags, Task task) {
        Intent intent = new Intent(activity, newClass);
        intent.addFlags(flags);
    ...
    public static void startNewActivity(Context activity, Class newClass) {
        Intent intent = new Intent(activity, newClass);
        activity.startActivity(intent);
    }
